...
from pageObjects.ITDAR import ITDAR
...
class TestITDAR:
    ...
    def test_login(self,setup):
        ...
        time.sleep(1.3)
        self.qapage.ClickDAR()
        time.sleep(1.3)
        self.qapage.ClickAddnew()
        time.sleep(1.3)
        self.qapage.SetSystemName()
        time.sleep(1.3)
        self.qapage.SetArcDataLoc("Media server datas")
        time.sleep(1.3)
        self.qapage.Setarchivalstatus()
        time.sleep(1.3)
        self.qapage.SetRemedial("Data Succeded")
        time.sleep(1.3)
        self.qapage.Subbtn()
        time.sleep(1.3)
        ...
        time.sleep(1.3)
        self.qapage.dynamicfltr("Success")
        time.sleep(3)
        self.driver.close()
        assert True
