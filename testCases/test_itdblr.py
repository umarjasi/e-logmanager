...
from pageObjects.ITDBLR import ITDBLR
...
class TestITDBLR:
    ...
    def test_login(self, setup):
        ...
        #ITDBLR
        self.qapage = ITDBLR(self.driver)
        self.qapage.ClickQC()
        time.sleep(1.3)
        self.qapage.ClickIT()
        time.sleep(1.3)
        ...
        time.sleep(1.3)
        self.qapage.ClickDBLR()
        time.sleep(1.3)
        self.qapage.ClickAddnew()
        time.sleep(1.3)
        self.qapage.SetSiteBlock()
        time.sleep(1.3)
        self.qapage.SetEqipname()
        time.sleep(1.3)
        self.qapage.SetArcDataLoc("DEquipmentsFolder")
        time.sleep(1.3)
        self.qapage.setremarks("Entry made")
        time.sleep(1.3)
        self.qapage.Subbtn()
        time.sleep(1.3)
        ...
        time.sleep(1.3)
        self.qapage.dynamicfltr("ZetaSizer")
        time.sleep(3)
        self.driver.close()
        assert True
