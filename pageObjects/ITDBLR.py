...
class ITDBLR():
     ...
     lnk_ot_xpath = "//span[normalize-space()='Data Backup Location Register']"
     drp_ssb_xpath = "//select[@id='DataBackupLocationData_Block']"
     drp_sen_xpath = "//select[@id='DataBackupLocationData_EquipmentName']"
     txtbox_sal_id = "DataBackupLocationData_BackupLocation"
     txtbox_rmarks_id = "DataBackupLocationData_Remarks"
     ...
     def scrolldown(self):
         ...
         init = self.driver.find_element(By.XPATH,"/html[1]/body[1]/div[1]/div[1]/div[1]/div[2]/nav[1]/ul[1]/li[2]/div[1]/ul[1]/li[5]/a[1]/span[1]")
         self.driver.execute_script("arguments[0].scrollIntoView();", init)
