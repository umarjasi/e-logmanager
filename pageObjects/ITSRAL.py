...
class ITSRAL():
     ...
     lnk_ot_xpath = "//span[normalize-space()='Server Room Access Log']"
     txtbox_sn_id = "SRAData_Name"
     drp_scn_xpath = "//select[@id='ddlCompany']"
     txtbox_rmarks_id = "SRAData_Reason"
     btn_subm_id = "btnSubmit"
     txtbox_esus_name = "txtUserName"
     txtbox_espa_name = "txtPassword"
     btn_sv_id = "btnESave"
     btn_subout_id = "btnOut"
     txtbox_revrem_id = "SRAData_ReviewComment"
     ...
     def SetCompanyName(self):
          rm_ele = self.driver.find_element(By.XPATH, self.drp_scn_xpath)
          rmd = Select(rm_ele)
     ...
     def scrolldown(self):
          ...
          init = self.driver.find_element(By.XPATH,"/html[1]/body[1]/div[1]/div[1]/div[1]/div[2]/nav[1]/ul[1]/li[2]/div[1]/ul[1]/li[8]/a[1]/span[1]")
          self.driver.execute_script("arguments[0].scrollIntoView();", init)
     ...
     def SubOut(self):
          self.driver.find_element(By.ID, self.btn_subout_id).click()
