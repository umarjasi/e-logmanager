...
class ITDAR():
     ...
     lnk_ot_xpath = "//span[normalize-space()='Data Archival Register']"
     drp_ssn_xpath = "//select[@id='DARData_SystemName']"
     txtbox_sal_id = "DARData_ArchivalDataLocation"
     drp_sas_xpath = "//select[@id='DARData_ArchivalStatus']"
     txtbox_raf_id = "DARData_RemedialActionForFailure"
     btn_subm_id = "btnSubmit"
     txtbox_esus_name = "txtUserName"
     txtbox_espa_name = "txtPassword"
     btn_sv_id = "btnESave"
     txtbox_revrem_id = "DARData_ReviewRemarks"
     btn_subrev_id = "btnclose"
     txtbox_apprem_id = "DARData_ApproveRemarks"
     ...
     def SetArcDataLoc(self, SAL):
          self.driver.find_element(By.ID, self.txtbox_sal_id).send_keys(SAL)

     def Setarchivalstatus(self):
          rm_ele = self.driver.find_element(By.XPATH, self.drp_sas_xpath)
          rmd = Select(rm_ele)
          rmd.select_by_index(1)

     def SetRemedial(self, RAF):
          self.driver.find_element(By.ID, self.txtbox_raf_id).send_keys(RAF)
     ...
     def scrolldown(self):
          ...
          init = self.driver.find_element(By.XPATH,"/html[1]/body[1]/div[1]/div[1]/div[1]/div[2]/nav[1]/ul[1]/li[2]/div[1]/ul[1]/li[4]/a[1]/span[1]")
          self.driver.execute_script("arguments[0].scrollIntoView();", init)
